...
public class PlayerRenderForTextureView implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public PlayerRenderForTextureView(Context context, GLSurfaceView preview, SimpleExoPlayer simpleExoPlayer) {
    ...
    public PlayerRenderForTextureView(Context context, GLSurfaceView preview, SimpleExoPlayer simpleExoPlayer, boolean previewFitView) {
