...
public class GLThread extends Thread {
    ...
    private RenderListener mRenderer;
    ...
    GLThread(EGLConfigChooser configChooser, EGLContextFactory eglContextFactory
            , EGLWindowSurfaceFactory eglWindowSurfaceFactory, RenderListener renderer
    ...
    public static class Builder {
        ...
        public Builder setRenderer(RenderListener renderer) {
