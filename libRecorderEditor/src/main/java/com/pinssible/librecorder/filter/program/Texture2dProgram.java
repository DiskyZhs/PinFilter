...
public class Texture2dProgram extends Program {
    ...
    private static final String VERTEX_SHADER =
            "uniform mat4 uMVPMatrix;\n" +
                    ...
                    "void main() {\n" +
                    "    gl_Position = uMVPMatrix * aPosition;\n" + // glPosition 是一个特殊的变量，用来存储最终的位置，所有的定点着色器必须写这个值（使用uMVPMatrix来对位置进行矩阵变化 ）
    ...
    private static final String FRAGMENT_SHADER_EXT_FILT =   //Fragment 使用卷积
            "#extension GL_OES_EGL_image_external : require\n" +
    ...
    public Texture2dProgram(ProgramType programType, Viewport previewViewport) {
    ...
    protected void init(ProgramType programType, Viewport previewViewport) {
        ...
        Log.e(TAG,"Texture2dProgram  init previewViewport = " + previewViewport.toString());
        ...
        muTouchPositionLoc = GLES20.glGetUniformLocation(mProgramHandle, "uPosition");  //触摸位置？效果？
    ...
    public void draw(float[] mvpMatrix, FloatBuffer vertexBuffer, int firstVertex,
        ...
        //Log.e(TAG,"openLerpBlur = "+ openLerpBlur);
        // Select the program.
